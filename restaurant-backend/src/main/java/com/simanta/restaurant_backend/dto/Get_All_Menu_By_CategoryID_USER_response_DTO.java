...
public class Get_All_Menu_By_CategoryID_USER_response_DTO {
    ...
    public Get_All_Menu_By_CategoryID_USER_response_DTO(Long id,String name,String description,Double price,String imageUrl,Boolean isAvailable,Boolean isVeg,
